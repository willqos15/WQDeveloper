                    ...
                    <div className={styles.infoh}>
                        ...
                        <ul>
                            ...
                            <li>- Git push e pull</li>
                                ...
                                <motion.section variants={Card}>
                    <div className={styles.ico}>
                        <img src="https://res.cloudinary.com/drklvmtqp/image/upload/v1767276125/Python.svg_xowlo9.png"></img>
                    </div>
